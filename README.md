# [SOLVED] Resolving-Javax-Net-Ssl-Sslhandshakeexception-Sun-Security-V
...
>
> ### ➡️ [CLICK HERE TO VIEW THE FULL FIX GUIDE](https://techfixdocs.my.id/resolving-javax-net-ssl-sslhandshakeexception-sun-security-v)
>
...
Check the certificate chain and ensure that all intermediate certificates are trusted, or update the truststore to include the necessary certificates.
...
👉 **[Go to ErrorFix Hub Full Article](https://techfixdocs.my.id/resolving-javax-net-ssl-sslhandshakeexception-sun-security-v)**
